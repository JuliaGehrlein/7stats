#code to calculate COHERENT CsI related physics
import numpy as np
...
#rebins with 1 E bin, 2 t bins (0-1 mu s, res)
...
#rebins with 2 E bin (up to 18, rest), 2 t bins (0-1 mu s, res)                                                                       
...
#rebins with 4 E bin (up to 18, 19-22,23-26,27-29), 2 t bins (0-1 mu s, res)                                                                                                                                          
